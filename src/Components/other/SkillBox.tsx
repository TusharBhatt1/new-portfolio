...
export default function SkillBox({ skill }: { skill: SkillsType }) {
  ...
  return (
    <div className="hover:bg-slate-200 bg-white cursor-pointer border border-black text-sm sm:text-md p-4 sm:p-12 flex flex-col justify-center items-center h-20 w-20 rounded-xl">
      <span
